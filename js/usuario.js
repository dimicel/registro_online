                ...
                for (i = 0; i < data["proceso"][proc].length; i++) {
                    ...
                    if (proc=="Convalidaciones"){
                        ...
                        if (item["resolucion"]=="PROCESADA"){
                            tabla += "<a style='margin-left:10px;color:GREEN' href='docs/"+id_nie+"/convalidaciones/"+ item["curso"] + "/"+item["registro"].slice(17)+"/docs/resolucion/resolucion.pdf?q="+new Date+"' target='_blank' title='Ver documento'>(Ver documento)</a>"
                        }
                        else{
