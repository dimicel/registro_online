...
$(function() {
    ...
    prom2=prom1.then((resp)=> {
        if (resp["error"] != "ok") document.write(resp["error"]);
            ...
            generaSelectCurso(document.getElementById("sel_curso"));
            document.getElementById("curso").value = _curso;
            document.getElementById("sel_curso").value = _curso;
    ...
    $.post("php/secret_recupera_ciclosfp.php", {grado:f_grado,dpto:f_dpto,diurno:f_diurno,vespertino:f_vespertino,nocturno:f_nocturno,elearning:f_elearning}, (resp) => {
        ...
        if (resp.error === "ok") {
            ...
            for (let i = 0; i < resp.registro.length; i++) {
                ...
                celdaCursos.style.textAlign = 'center';
...
function listaRegistros(orden_campo, orden_direccion) {
    ...
    if (tipo_formulario == "revision_examen") {
        ...
        estilo = ["width:70px", "width:220px", "width:85px;text-align:center;", "width:70px;text-align:center;", "width:70px;text-align:center;", "width:70px;text-align:center;", "width:70px;text-align:center;", "width:70px;text-align:center;", "width:70px;text-align:center;" ];
        encabezamiento = ["NIE", "Alumno", "Fecha Reg.","Centro","Proc.Centro","Consej.","Proc.Cons.","Minist.","Proc.Minist."];
    ...
    if(tipo_formulario=="convalidaciones" || tipo_formulario=="exencion_fct"){
        ...
        encab = "<tr>";
        encab += `<td style='width:30px; text-align:center'>
            <input type='checkbox' onchange='document.querySelectorAll("[data-checkbox=item_transporte]").forEach(checkbox => {checkbox.checked = this.checked;});'>
          </td>`;
        for (i = 0; i < encabezamiento.length; i++) {
             encab += "<td style='"+ estilo[i] + "'>" + encabezamiento[i] + "</td>";
        }
...
function verRegAdjuntosConvalid(reg){
    ...
    $.post("php/secret_convalid_adjuntos.php",{registro:reg},(resp2)=>{
        ...
        document.getElementById("ver_reg_adjuntosConvalid").innerHTML=_div;
    },"json");
}
    ...
    $.post("php/secret_recuperaregistro.php", { formulario: form, registro: registro }, function(resp) {
        ...
        if (resp.error == "server") alerta("Error en el servidor. Inténtalo más tarde.", "Error de servidor");
            ...
            if (form == "revision_examen") {
                ...
                if (form == "premat_2eso") {
                    contenido += "<span class='verReg_label'>Materia 1: </span><span class='verReg_campo'>" + resp.registro.materia1 + "</span><br>";
                    contenido += "<span class='verReg_label'>Materia 2: </span><span class='verReg_campo'>" + resp.registro.materia2 + "</span><br>";
                    contenido += "<span class='verReg_label'>Materia 3: </span><span class='verReg_campo'>" + resp.registro.materia3 + "</span><br>";
                    contenido += "<span class='verReg_label'>Materia 4: </span><span class='verReg_campo'>" + resp.registro.materia4 + "</span><br>";
                    contenido += "<span class='verReg_label'>Materia 5: </span><span class='verReg_campo'>" + resp.registro.materia5 + "</span><br>";
                    contenido += "<span class='verReg_label'>Materia 6: </span><span class='verReg_campo'>" + resp.registro.materia6 + "</span><br>";
                    ...
                    contenido += "<span class='verReg_label'>Materia 5: </span><span class='verReg_campo'>" + resp.registro.materia5 + "</span><br>";
                    contenido += "<span class='verReg_label'>Materia 6: </span><span class='verReg_campo'>" + resp.registro.materia6 + "</span><br>";
                    contenido += "<span class='verReg_label'>Materia 7: </span><span class='verReg_campo'>" + resp.registro.materia7 + "</span><br>";
                    contenido += "<span class='verReg_label'>Materia 8: </span><span class='verReg_campo'>" + resp.registro.materia8 + "</span><br>";
                    contenido += "<span class='verReg_label'>Materia 9: </span><span class='verReg_campo'>" + resp.registro.materia9 + "</span><br>";
                    contenido += "<span class='verReg_label'>Materia 10: </span><span class='verReg_campo'>" + resp.registro.materia10 + "</span><br>";
                    contenido += "<span class='verReg_label'>Materia 11: </span><span class='verReg_campo'>" + resp.registro.materia11 + "</span><br>";
                    contenido += "<span class='verReg_label'>Materia 12: </span><span class='verReg_campo'>" + resp.registro.materia12 + "</span><br>";
                    contenido += "<span class='verReg_label'>Materia 13: </span><span class='verReg_campo'>" + resp.registro.materia13 + "</span><br>";
                    contenido += "<span class='verReg_label'>Materia 14: </span><span class='verReg_campo'>" + resp.registro.materia14 + "</span><br>";
                    ...
                    contenido += "<span class='verReg_label'>Materia 13: </span><span class='verReg_campo'>" + resp.registro.materia13 + "</span><br>";
                    contenido += "<span class='verReg_label'>Materia 14: </span><span class='verReg_campo'>" + resp.registro.materia14 + "</span><br>";
                    contenido += "<span class='verReg_label'>Materia 15: </span><span class='verReg_campo'>" + resp.registro.materia15 + "</span><br>";
                    contenido += "<span class='verReg_label'>Materia 16: </span><span class='verReg_campo'>" + resp.registro.materia16 + "</span><br>";
                    contenido += "<span class='verReg_label'>Materia 17: </span><span class='verReg_campo'>" + resp.registro.materia17 + "</span><br>";
                    contenido += "<span class='verReg_label'>Materia 18: </span><span class='verReg_campo'>" + resp.registro.materia18 + "</span><br>";
                    contenido += "<span class='verReg_label'>Materia 19: </span><span class='verReg_campo'>" + resp.registro.materia19 + "</span><br>";
                    contenido += "<span class='verReg_label'>Materia 20: </span><span class='verReg_campo'>" + resp.registro.materia20 + "</span><br>";
                    contenido += "<span class='verReg_label'>Materia 21: </span><span class='verReg_campo'>" + resp.registro.materia21 + "</span><br>";
...
function verRegistroConvalidaciones(num_registro){
    ...
    $.post("php/secret_recuperaregistro.php", { formulario: formulario, registro: num_registro }, function(resp) {
        ...
        if (resp.error == "server") alerta("Error en el servidor. Inténtalo más tarde.", "Error de servidor");
            ...
            dir_solicitud="docs/"+resp.registro.id_nie+"/convalidaciones/"+document.getElementById("curso").value+"/"+num_registro.slice(-17)+"/"+num_registro+".pdf";
            ...
            contenido +="<div id='ver_reg_adjuntosConvalid'></div>"
...
function verRegistroExencionFCT(num_registro,rutaInforme,rutaResolucion){
    ...
    $.post("php/secret_recuperaregistro.php", { formulario: formulario, registro: num_registro }, function(resp) {
        ...
        if (resp.error == "server") alerta("Error en el servidor. Inténtalo más tarde.", "Error de servidor");
            ...
            dir_solicitud="docs/"+resp.registro.id_nie+"/exencion_form_emp/"+document.getElementById("curso").value+"/"+num_registro.slice(-17)+"/"+num_registro+".pdf";
            contenido += "<span class='verReg_label'>NIE: </span><span class='verReg_campo'>" + resp.registro.id_nie +"</span><span class='verReg_label' style='margin-left:5px'>NIF: </span><span class='verReg_campo'>" + resp.registro.id_nif +"</span><span class='verReg_label' style='margin-left:5px'>Nº Registro: </span><span class='verReg_campo'>" + num_registro +"</span><br>";
            contenido += "<span class='verReg_label'>Alumno: </span><span class='verReg_campo'>" + resp.registro.apellidos +", "+resp.registro.nombre+ "</span><br>";
...
function altaUsuario() {
    ...
    if (document.getElementById("nr_nif").value!= '' && !document.getElementById("nr_es_pasaporte").checked) {
        ...
        if(!_dni_valido || !_dni_noduplicado){
            if (!_dni_valido){
                document.getElementById("feedback_nif").innerText="El NIF o NIE no es válido";
            }
            else if(!_dni_noduplicado){
                document.getElementById("feedback_nif").innerText="El nº ya está registrado";
            }
...
function verDocsMatricula(id, edad="0", curso_escolar) {
    let existe_foto=false, existe_dni_A=false, existe_dni_R=false, existe_seguro=false,existe_certificado=false,existe_num_ss=false, mayor_de_28=false;
    mostrarPantallaEspera("Cargando ...");
    ...
    .then ((dialogo)=>{
            ...
            d2 = d1.then ((resp) => {
                ...
                if (resp.datos.mayor_de_28=="1")mayor_de_28=true;
                else mayor_de_28=false;
            ...
            d2.then((resp) => {
                ...
                if (document.getElementById("es_pasaporte").value==1){
                    $("#sec_foto").removeClass("col-md-4");
                    $("#sec_foto").addClass("col-md-6");
                    $("#sec_documento_id").removeClass("col-md-8");
                    $("#sec_documento_id").addClass("col-md-6");
                    ...
                    $("#sec_foto").removeClass("col-md-6");
                    $("#sec_foto").addClass("col-md-4");
                    $("#sec_documento_id").removeClass("col-md-6");
                    $("#sec_documento_id").addClass("col-md-8");
                    document.getElementById("texto_DNI_NIE_PASAPORTE").innerText="DNI/NIE";
                ...
                if(existe_seguro){
                    ...
                    if (edad==">28" || mayor_de_28==true) document.getElementById("txt_no_seguro").innerText="Mayor de 28 años";
                }
            });
...
function descargaCsvExcel(tipo_listado){
    mostrarPantallaEspera("Cargando ...");
    cargaHTML("html/secretaria.htm", "div_seleccion_csv_excel","SELECCIÓN DE FORMATO",300,400,"center_top","center_top",
        [
            {
...
function cancelaOPeracionCiclosFP(obj){
    ...
    document.getElementById("form_nuevo_ciclo").reset();
...
function compruebaDuplicadoCicloFP(){
    ...
    $.post("php/secret_comprueba_duplicado_ciclofp.php",{accion:accion,id:$("#ciclo_id").val(),ciclo:$("#ciclo_ciclo").val()},(resp)=>{
        //ocultarPantallaEspera();
        if (resp=="duplicado" || resp=="duplicado_normalizado"){
...
function generaTablasCursosFP(){
    ...
    $.post("php/secret_recupera_modulos_cursosfp.php",{id:id_ciclo},(resp)=>{
        ocultarPantallaEspera();
        if (resp.error=="ok"){
            var num_cursos = Object.keys(resp["registro"]).length;
...
function altaModRutaParadaTranporte(alta_mod,tipo,ruta="",parada="",hora_parada=""){
    ...
    if (tipo=="ruta") ancho_ventana=300;
    else ancho_ventana=500;
    cargaHTML("html/secretaria.htm", "div_altas_mod_rutas_paradas",titulo,ancho_ventana,400,"","",
        [
            {
                class: "btn btn-success textoboton btn-sm",
                text: "Aceptar",
                click: function() {
                    ...
                    $.post("php/secret_transporte_alta_mod_rutas_paradas.php",
                            ...
                            (resp)=>{
                                ...
                                else if (resp=="ok_alta_ruta") console.log("Ruta añadida.");//alerta ("Ruta añadida.","OK");
                                else if (resp=="alta_parada_existente") alerta ("No se puede la parada porque ya existe una en la misma ruta.","DUPLICADO PARADA");
                                else if (resp=="ok_alta_parada") console.log("Parada añadida a la ruta.");//alerta ("Parada añadida a la ruta.","OK");
                                else if(resp=="mod_ruta_existente") alerta ("No se puede modificar la ruta porque el nombre ya existe.", "DUPLICADO RUTA");
                                else if(resp=="mod_ruta_ok") console.log("Ruta modificada.");//alerta ("Ruta modificada.", "OK");
                                ...
                                else if(resp=="mod_parada_ok") console.log("Parada modificada.");//alerta ("Parada modificada.", "OK");
