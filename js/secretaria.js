        ...
        if (resp.error == "server") alerta("Error en el servidor. Inténtalo más tarde.", "Error de servidor");
            ...
            for (i = 0; i < data_array.length; i++) {
                ...
                if (tipo_formulario.indexOf("matricula")==-1){
                    if (data_array[i].procesado==1) data += "<td style='width:110px'><center><input type='checkbox' checked onclick='javascript:event.stopPropagation(); formularioProcesado(this.parentNode.parentNode.parentNode.parentNode.innerHTML);'/></center></td></tr>";
                    else  data += "<td style='width:110px'><center><input type='checkbox' onclick='javascript:event.stopPropagation(); formularioProcesado(this.parentNode.parentNode.parentNode.parentNode.innerHTML);'/></center></td></tr>";
                }
            }
