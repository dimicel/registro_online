        ...
        if (resp.error == "server") alerta("Error en el servidor. Inténtalo más tarde.", "Error de servidor");
            ...
            if (form == "revision_examen") {
                ...
                $.post("php/secret_convalid_adjuntos.php",{registro:registro},(resp2)=>{
                    ...
                    contenido += "</div></div>";
                    contenido+="<input type='file' id='ver_reg_resolucion' multiple='false' style='position:absolute;left:-9999px' onchange='adjuntaResolucion("+resp.registro.id_nie+","+registro+",this)'/>";
                    contenido += "<span class='verReg_label'>INCIDENCIAS DE LA SOLICITUD: </span><br>";
