...
function adjuntaDocAdicional(_id_nie,registro){
    ...
    c+="<div class='col-4 ml-2'><input type='text' class='form-control' id='desc_adic_conval' name='desc_adic_conval' maxlength='40' /></div>";
    c+="<div class='col-1'><label for='doc_adic_conval' class='col-form-label'>Documento: </label></div>";
    c+="<div class='col-4 ml-2'><input type='text' class='form-control' id='doc_adic_conval' readonly placeholder='Seleccionar documento' onclick='document.getElementById(\"conval_doc_adicional\").click()'/></div>";
    c+="</div>";
