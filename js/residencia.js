    ...
    $.post("php/residencia_comedor_listado.php",{curso:document.getElementById("res_curso").value,fecha:fechaStr},(resp)=>{
        ...
        if (resp.error=="ok"){
            ...
            for (let i=0;i<resp.registros.length;i++){
                ...
                if (resp.registros[i].desayuno==0)_lt+="<td width='5%' style='text-align:center' onclick='javascript:if(this.innerHTML==\"X\")this.innerHTML=\"\";else this.innerHTML=\"X\";' ontouchstart='javascript:if(this.innerHTML==\"X\")this.innerHTML=\"\";else this.innerHTML=\"X\";'></td>";
