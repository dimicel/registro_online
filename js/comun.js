...
function confirmarAccion(mensaje, titulo, ancho) {
    if (typeof(ancho) != 'number') ancho = 300;
    document.getElementById('mensaje_div').innerHTML = "<div>" + mensaje + "</div>" + "<br><div display='inline-block'><input type='button' class='textoboton btn btn-success' value='Ok' onclick=''$(\"#mensaje_div\").dialog(\"close\");return true;'/>";
