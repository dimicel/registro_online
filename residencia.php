        ...
        <div id="res_usu_reg_tab" class="ui-widget-header ui-corner-all" >
            ...
            <div class="row" style="margin-top:15px">
                ...
                <div class="col-1" style="margin-left:-35px">
                    <input type="text" class="form-control" id="filtro_edificio" size="5" maxlength="20" class="col-2" style="margin-left:0px" onchange="res_listaUsus()" onkeypress="if(event.keyCode==13) res_listaUsus()">
                </div>
            </div>
            <div class="row">
                <div class="col-12 text-center">
                    <span style="font-size: 0.75em">
                        Para cambiar FECHA DE ALTA, la FIANZA, el estado BONIFICADO/NO BONIFICADO, BAJA o el EDIFICIO asignado al residente, haz doble clic sobre la celda correspondiente.
                    </span>
                </div>
            </div>   
