...
if ($filtro == 1) $consulta="select * from ciclos order by descripcion ASC, grado ASC";
else  $consulta="select * from ciclos where " . $filtro . " order by descripcion ASC, grado ASC";
