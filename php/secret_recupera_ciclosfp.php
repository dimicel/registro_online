...
if ($filtro == 1) $consulta="select * from ciclos order by denominacion ASC, grado ASC";
else  $consulta="select * from ciclos where " . $filtro . " order by denominacion ASC, grado ASC";
