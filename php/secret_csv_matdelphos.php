...
$body_html.="<p>Acceso al Registro online en el siguiente enlace: <a href='https://www.ulaboral.org/registro_online/' target='_blank'>https://www.ulaboral.org/registro_online/</a></p>";
...
$body_html.="</ul>";
$body_html.="<p>Todo el alumnado que ha estado matriculado en el centro durante el curso 2021-2022 ya tiene el NIE y la contraseña. No obstante, en el correo que recibirán para completar la matrícula, se les recordará el NIE. Si no recuerdan la contraseña, pueden recuperarla, a través del enlace &#8220;Recuperar contraseña&#8221; y la recibirán en el correo electrónico que facilitaron cuando accedieron por primera vez al Registro online.</p>";
...
$body_html.="<ul>";
$body_html.="<li>El alumnado que ha estado matriculado en el centro durante el curso 2021-2022, y que ha realizado prematrícula, deberá indicar en la primera pantalla si ha elegido las mismas materias que en la prematrícula o no, seleccionando una casilla u otra. (Este apartado no afecta a los alumnos que se matriculan por primera vez en el centro).</li>";
$body_html.="<li>Transporte escolar: si se ha seleccionado la opción <strong>transporte escolar</strong> de la primera página, al completar los datos personales en el trámite relativo al paso 2, al finalizar el proceso se abrirá el formulario para cumplimentar la solicitud de transporte escolar<strong>.</strong></li>";
