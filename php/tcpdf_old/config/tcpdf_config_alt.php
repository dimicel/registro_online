 ...
 */
define ('PDF_HEADER_LOGO', 'mini_escudo.jpg');
 ...
 * Header title.
 */
define ('PDF_HEADER_TITLE', "Generado por Bolsa de Trabajo del IES Universidad Laboral");

/**
 * Header description string.
 */
define ('PDF_HEADER_STRING', "TOLEDO");
