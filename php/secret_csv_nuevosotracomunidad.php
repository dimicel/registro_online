...
$sql="SELECT id_nie,apellidos,nombre,curso,al_nuevo_otracomunidad 
        FROM mat_fpb 
        WHERE al_nuevo_otracomunidad='Si' and curso=? 
        UNION ALL 
        SELECT id_nie,apellidos,nombre,curso,al_nuevo_otracomunidad 
        FROM mat_ciclos 
        WHERE al_nuevo_otracomunidad='Si' and curso=? 
        UNION ALL  
        SELECT id_nie,apellidos,nombre,curso,al_nuevo_otracomunidad 
...
$Name = 'alumnos_nuevos_de_otra_comunidad_'.$curso;


$encabezamiento=["NIE", "APELLIDOS", "NOMBRE"];
