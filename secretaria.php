...
<body>
    <div id="panel" style="display: block;  padding: 5px; width:1050px" class="ui-widget-header ui-corner-all centrado">
        ...
        <div id="doc_reg_tab" class="ui-widget-header ui-corner-all">
            ...
            <div style="margin-top:20px;" id="div_listados_formularios">
        ...
        <form id="form_departamentos">
            ...
            <div class="row mt-3">
                <div class="col-5">
                    ...
                    <span class="errorTxt" style="font-size: 1em;"></span>
                    <input type="text" id="dpto_nombre" name="dpto_nombre" class="form-control" maxlength="255" readonly onkeypress="compruebaDuplicadoDpto(this)">
                </div>
                <div class="col-2">
                    <label for="dpto_abreviatura">Abreviatura</label>
                    <span class="errorTxt" style="font-size: 1em;"></span>
                    <input type="text" id="dpto_abreviatura" name="dpto_abreviatura" class="form-control" maxlength="4" readonly onkeypress="compruebaDuplicadoDpto(this)"> 
                </div>
