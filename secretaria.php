    ...
    <div class="container alertas" id="div_departamentos">
        <form id="form_departamentos">
            ...
            <div class="row mt-3">
                ...
                <div class="col-5 " style="text-align: center;display:none" id="div_boton_guardar_cambios">
                    <div class="w-100 d-flex justify-content-end">
                        ...
                        <button type="button" id="btn_cancela_nuevo_dpto" class="btn btn-danger btn-sm ml-2" onclick="gestionSeleccionDpto();this.parent.style.display='none'">Cancelar</button>
                    </div>
                </div>
            </div>
        </form>
