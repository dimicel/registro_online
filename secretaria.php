        ...
        <form id="form_departamentos">
            ...
            <div class="row mt-3">
                <div class="col-5">
                    ...
                    <span class="errorTxt" style="font-size: 1em;"></span>
                    <input type="text" id="dpto_nombre" name="dpto_nombre" class="form-control" maxlength="255" readonly onkeyup="compruebaDuplicadoDpto(this)">
                </div>
                <div class="col-2">
                    <label for="dpto_abreviatura">Abreviatura</label>
                    <span class="errorTxt" style="font-size: 1em;"></span>
                    <input type="text" id="dpto_abreviatura" name="dpto_abreviatura" class="form-control" maxlength="4" readonly onkeyup="compruebaDuplicadoDpto(this)"> 
                </div>
