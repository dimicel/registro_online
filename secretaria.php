                ...
                <ul class="nav bg-white" style="font-size:0.7em !important">
                    ...
                    <li class="nav-item" id="menu8">
                        ...
                        <div class="dropdown-menu" >
                            ...
                            <a id="CSV_doc_ident" data="csv_tra_seg" class="dropdown-item small" href="#" onclick="listadoDocumnetoIdentificacion()">CSV Nº Documento Identificación</a>
            ...
            <div style="margin-top:20px">
                ...
                <form>
                    <div id="div_nuevos_otra_comunidad" class="form-group row" style="margin-top: 10px; display: none;">
                        <div class="custom-control custom-switch col align-content-center" style="margin-left:20px">
                            <center>
