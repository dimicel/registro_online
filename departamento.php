...
<body>
    <div id="panel" style="display: block;  padding: 5px; width:990px" class="ui-widget-header ui-corner-all centrado">
        ...
        <div style="display:table-cell; vertical-align: middle; padding-left: 20px">
            ...
            <h3>GESTIÓN DEL REGISTRO ONLINE</h3>
            <h4 id="rotulo_tipo_usu">DEPARTAMENTO</h4>
        </div>
        ...
        <div id="usu_reg_tab" class="ui-widget-header ui-corner-all" >
            ...
            <div class="row" style="margin-top:15px">
                ...
                <div class="col-1">
                    <input type="button" id="boton_salir" style="float:right" class="textoboton btn btn-success" value="Cerrar Sesión" onclick="javascript: cierrasesion();">
                </div>
            </div>
