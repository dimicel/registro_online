    ...
    if (p == "+") {
        ...
        if (pag_html == "pagina_3"){
            ...
            if (primera_vez_pag_5){
                ...
                if (existe_foto){
                    document.getElementById("img_foto").src="../../docs/fotos/"+id_nie+".jpeg?t="+Date.now();
                }
                if (existe_tarjeta_san){
                    document.getElementById("img_tarjeta_sanitaria").src="../../docs/"+id_nie+"/tarjeta_sanitaria/ts_"+id_nie+".jpeg?t="+Date.now();
                }
            }
        }
    }
