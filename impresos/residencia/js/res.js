...
function registraSolicitud() {
    ...
    f.bonificado.value=encodeURIComponent(document.querySelectorAll("input[name='res_bonif']:checked").value);
    f.appendChild(encodeURIComponent(f1.nombre));
    f.appendChild(encodeURIComponent(f1.apellidos));
    f.appendChild(encodeURIComponent(f1.nif_nie));
    f.appendChild(encodeURIComponent(f1.tlf_urgencias));
    f.appendChild(encodeURIComponent(f1.fech_nac));
    f.appendChild(encodeURIComponent(f1.edad));
    f.appendChild(encodeURIComponent(f1.num_hermanos));
    f.appendChild(encodeURIComponent(f1.lugar_hermanos));
    f.appendChild(encodeURIComponent(f1.tlf_alum));
    f.appendChild(encodeURIComponent(f1.email_alumno));
    f.appendChild(encodeURIComponent(f1.num_ss));
    f.appendChild(encodeURIComponent(f1.direccion));
    f.appendChild(encodeURIComponent(f1.localidad));
    f.appendChild(encodeURIComponent(f1.provincia));
    f.appendChild(encodeURIComponent(f1.cp));
    f.appendChild(encodeURIComponent(f2.estudios));
    f.appendChild(encodeURIComponent(f2.tutor));
    f.appendChild(encodeURIComponent(f2.centro_est));
    f.appendChild(encodeURIComponent(f2.tlf_centro_est));
    f.appendChild(encodeURIComponent(f2.email_centro_est));
    f.appendChild(encodeURIComponent(f2.centro_proc));
    f.appendChild(encodeURIComponent(f2.tlf_centro_proc));
    f.appendChild(encodeURIComponent(f2.email_centro_proc));
    f.appendChild(encodeURIComponent(f3.tut1_nom));
    f.appendChild(encodeURIComponent(f3.tut1_profesion));
    f.appendChild(encodeURIComponent(f3.tut1_estudios));
    f.appendChild(encodeURIComponent(f3.tut1_telef));
    f.appendChild(encodeURIComponent(f3.tut1_email));
    f.appendChild(encodeURIComponent(f3.tut2_nom));
    f.appendChild(encodeURIComponent(f3.tut2_profesion));
    f.appendChild(encodeURIComponent(f3.tut2_estudios));
    f.appendChild(encodeURIComponent(f3.tut2_telef));
    f.appendChild(encodeURIComponent(f3.tut2_email));
    f.appendChild(encodeURIComponent(f4.enfermedad_pasada));
    f.appendChild(encodeURIComponent(f4.enfermedad));
    f.appendChild(encodeURIComponent(f4.medicacion));
    f.appendChild(encodeURIComponent(f4.alergias));
    f.appendChild(encodeURIComponent(f4.otros_datos));
    f.appendChild(encodeURIComponent(f6.bic));
    f.appendChild(encodeURIComponent(f6.iban));
