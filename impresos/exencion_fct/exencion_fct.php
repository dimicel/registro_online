...
<body>
    ...
    <div class="container" style="width:38%">    
        ...
        <div class="row ui-widget-header ui-corner-all" style="padding-left:10px; padding-right:10px">
            <div  style="display:inline-block;margin-top:10px;margin-left:10px">
                <input type="button" value="&#x21c7;" class="btn btn-danger btn-sm" data-toggle="tooltip" data-placement="right" title="Regresar a página principal" onclick="confirmarSalida('../../usuario.php')" />
            </div>
            <div class="row mt-2" >
                <div class="col">
                    <div class="row mt-3">
                        ...
                        <div class="col">
                            <label for="nombre_" style="margin-left:10px">*Nombre</label>
                        </div>
                        <div class="col">
                            <label for="apellidos_" style="margin-left:10px">*Apellidos</label>
                        </div>
                        <div class="col-3">
                            <label for="nif_nie_" style="margin-left:10px">*NIF/NIE/Pasaporte</label>
                        </div>
                    </div>
                    <div class="row">
                        <div class="col-2">
                    ...
                    <div class="row">
                        <div class="col" >
                            <span id="error_tabla" class="errorTxt" style="font-size: 0.75em;"></span>
    ...
    <!-- CONTENEDOR DE LOS INPUTS HIDDEN GENERADOS DINÁMICAMENTE ----------------------------------------------------------------->
