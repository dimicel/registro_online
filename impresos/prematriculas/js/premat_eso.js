...
function registraMatricula() {
    ...
    $.when(pet).done(function(resp) {
        ...
        if (resp == "servidor") {
            ...
            alerta("Proceso finalizado correctamente.<br>RECUERDE: El documento generado no es la matrícula del curso que viene.<br>El proceso de matriculación comienza hacia el mes de JULIO.<br>Puede descargar el formulario registrado desde el panel de control de usuario.", "Registro correcto", '../../usuario.php', 500);
        }
    });
}
