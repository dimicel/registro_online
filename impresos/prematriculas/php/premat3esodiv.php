...
function generaRegistro(){
    ...
    shuffle($array);
    return "iesulabto_pm3esd_".date('dmY')."_".$array[0].$array[1].$array[2].$array[3].$array[4].$array[5].$array[6].$array[7];;    
}
...
$opt1=$_POST['eso3_div_opt1'];
$opt2=$_POST['eso3_div_opt2'];
$opt3=$_POST['eso3_div_opt3'];
$opt4=$_POST['eso3_div_opt4'];
...
//Curso y año
$html1 = <<<HTML1
<h3>3º ESO DIVERSIFICACIÓN</h3><br>
...
$pdf->RoundedRect(78,$YInicio,53,21,2,'1111','','','');
