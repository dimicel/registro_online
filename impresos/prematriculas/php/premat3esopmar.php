...
function generaRegistro(){
    ...
    shuffle($array);
    return "iesulabto_pm3esp_".date('dmY')."_".$array[0].$array[1].$array[2].$array[3].$array[4].$array[5].$array[6].$array[7];;    
}
...
$opt1=$_POST['eso3_pmar_opt1'];
$opt2=$_POST['eso3_pmar_opt2'];
$opt3=$_POST['eso3_pmar_opt3'];
$opt4=$_POST['eso3_pmar_opt4'];
...
$pdf->SetXY($XInicio,$YInicio);
$pdf->SetFont('dejavusans', '', 8, '', true);
$pdf->Cell(90,4,"MATERIAS COMUNES                                       Horas Semanales",1,0,'L',1,'',0,true,'T','T');
$pdf->SetX(105);
$pdf->Cell(87,4," Pref. MATERIAS OPTATIVAS                         Horas Semanales",1,0,'L',1,'',0,true,'T','T');
...
$fil_2=$pdf->MultiCell(70,0,$mat_optativas,0,'L',0,1,'','',true,0,false,false,0);
