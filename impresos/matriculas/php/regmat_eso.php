...
$registro=generaRegistro($mysqli, "mat_eso", $desc_reg[$curso]."_");
...
$pdf->SetKeywords('ulaboral, PDF, secretaría, '. $datos_cen["localidad_centro"].', Impreso Matrícula');
...
$YInicio=45;
$pdf->RoundedRect(77,$YInicio,55,21,2,'1111','','','');
