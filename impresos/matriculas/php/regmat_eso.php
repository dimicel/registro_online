...
$transporte=$_POST['_transporte'];
$fecha_registro=date('Y-m-d');
$prog_ling=$_POST['_prog_ling'];
...
//DATOS INICIALES
$pdf->RoundedRect(22,$YInicio-2,165,8,2,'1111','','','');

$pdf->SetXY(27,$YInicio);
$pdf->SetFont('dejavusans', '', 8, '', true);
$pdf->Cell(0,0,"Alumno Nuevo:       Inicia enseñanza en otra com.:        Repite Curso:        Interno:        Solicita Trans. Esc.:",0,0,'L',0,'',1,false,'','');
...
$pdf->SetX(178);
$pdf->Cell(0,0,$transporte,0,0,'L',0,'',1,false,'','');
...
-Legitimación: Cumplimiento de una obligación legal / Ejercicio de poderes públicos – Ley Orgánica 2/2006, de 3 de mayo, de Educación / Ley 7/2010, de 20 de julio, de Educación de Castilla-La Mancha.
