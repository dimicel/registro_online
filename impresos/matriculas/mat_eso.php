...
<body>
    <div style="display:none">
        <form id="matricula_eso" name="matricula_eso" class="needs-validation" novalidate method="post">
            ...
            <input type="hidden" name="_prog_ling" id="_prog_ling" />
            <input type="hidden" name="_alumno_nuevo" id="_alumno_nuevo" />
            <input type="hidden" name="_nuevo_otra_comunidad" id="_nuevo_otra_comunidad" />
            <input type="hidden" name="consolida_premat" id="consolida_premat" />
            <input type="hidden" name="_repetidor" id="_repetidor" />
            <input type="hidden" name="_interno" id="_interno" />
            <input type="hidden" name="_transporte" id="_transporte" />
    ...
    <div class="container w-100">
        ...
        <!--PAGINA 5 ELECION MATERIAS------------------------------------------------------------------------------------------------------------------------------------------------------>
        <div id="pagina_5" class="ui-widget-header ui-corner-all col-10 justify-content-center flex-column" style="display:none"></div>

        <!--PAGINA 6 TRANSPORTE ESCOLAR - REPRESENTANTE------------------------------------------------------------------------------------------>
        ...
        <!--PAGINA 7 TRANSPORTE ESCOLAR - TIPO SERVICIO SOLICITADO------------------------------------------------------------------------------------------>
        ...
        <!--PAGINA 8 TRANSPORTE ESCOLAR - AUTORIZACIONES------------------------------------------------------------------------------------------>
        <div id="pagina_8" class="ui-widget-header ui-corner-all col-10 offset-1 justify-content-center flex-column" style="display:none"></div>

        <!--PAGINA 9 TRANSPORTE ESCOLAR - DECLARACIONES RESPONSABLES------------------------------------------------------------------------------------------>
        <div id="pagina_9" class="ui-widget-header ui-corner-all col-10 offset-1 justify-content-center flex-column" style="display:none"></div>
        <!--PAGINA 10 SUBIDA ARCHIVOS------------------------------------------------------------------------------------------>
        <div id="pagina_10" class="ui-widget-header ui-corner-all col-10 offset-1 justify-content-center flex-column" style="display:none"></div>

        <!--PAGINA 11 PROTECCIÓN DATOS------------------------------------------------------------------------------------------>
        <div id="pagina_11" class="ui-widget-header ui-corner-all col-10 offset-1 justify-content-center flex-column" style="display:none"></div>

        <!--PAGINA 12 FINAL (REGISTRO)------------------------------------------------------------------------------------------>
        <div id="pagina_12" class="ui-widget-header ui-corner-all col-10 offset-1 justify-content-center flex-column" style="display:none"></div>
    </div>
    ...
    <script src=<?php echo "js/mat_eso.js?q=".time();?> type="text/javascript"></script>
