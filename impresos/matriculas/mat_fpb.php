...
<head>
    ...
    <title>MATRÍCULA CICLOS FPB</title>
</head>

<body>
    <div class="container w-100">
        <div style="display:none;">
            <form id="mat_fpb" name="mat_fpb" method="post" action="php/generapdf_matfpb.php">
                ...
                <input type="hidden" name="registro_matricula" id="registro_matricula" />
        ...
        <div class="d-flex flex-row justify-content-center" style="margin-top:30px">
            ...
            <div class="col-8 justify-content-center" style="text-align: center;">
                ...
                <h6>SOLICITUD: COMPLEMENTO MATRÍCULA DE CICLOS FORMATIVOS</h6><br>
        ...
        <!--Código HTML de las páginas están en fpb_html-->
        ...
        <!--PAGINA 4 TRANSPORTE-TUTOR LEGAL----------------------------------------------------------------------------------------->
        ...
        <!--PAGINA 5 TRANSPORTE-TIPO DE SERVICIO----------------------------------------------------------------------------------------->
        ...
        <!--PAGINA 6 TRANSPORTE-AUTORIZACIONES----------------------------------------------------------------------------------------->
        ...
        <!--PAGINA 7 TRANSPORTE-DECLARACIONES----------------------------------------------------------------------------------------->
    ...
    <script src=<?php echo "js/mat_fpb.js?q=".time();?> type="text/javascript"></script>
    <script src=<?php echo "js/validadores_fpb.js?q=".time();?> type="text/javascript"></script>
