...
function pasaPagina(p) {
    ...
    pag = "ciclos_html/" + _paginas[pagina - 1][0] + ".html?q="+Date.now().toString();
...
function muestraAyudaDocs(){
    ...
    mensaje_docs += "    <li style='font-size:0.75em;'>EXCEPTO nacidos antes del 31/12/" + (anno_ini_curso-27) + ", una fotografía del resguardo del pago del seguro escolar, y del anverso y reverso del documento de identificación (DNI/NIE). (Móvil en horizontal y fondo blanco, por ejemplo, sobre un folio).</li>";
    mensaje_docs += "    <li style='font-size:0.75em;'>Si es alumno nuevo e inició los estudios de los que se matricula en otra comunidad autónoma, certificado de notas en formato PDF (puede escanearlo, por ejemplo, con la aplicación gratuita para móvil Microsoft Office Lens).</li>";
    mensaje_docs += "</ul>";
    mensaje_docs += "</p>";   
