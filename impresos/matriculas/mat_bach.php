...
<head>
    ...
    <title>MATRÍCULA BACHILLERATO</title>
</head>

<body>
    <div style="display:none">
        <form id="matricula_bach" name="matricula_bach" class="needs-validation" novalidate method="post">
    ...
    <div class="container w-100">
        ...
        <div class="d-flex flex-row justify-content-center" style="margin-top:30px">
            ...
            <div class="col-8 justify-content-center" style="text-align: center;">
                <h2>FORMULARIO NO VÁLIDO SIN LA FORMALIZACIÓN DE MATRÍCULA EN EDUCAMOS</h2>
                <h5>IES UNIVERSIDAD LABORAL DE TOLEDO</h5>
                <h5>REGISTRO ONLINE</h5>
                <h6>SOLICITUD: MATRÍCULA DE BACHILLERATO</h6><br>
        ...
        <!--PAGINA 4 ELECCION MATERIAS------------------------------------------------------------------------------------------------------------------------------------------------------>
        <div id="pagina_4" class="ui-widget-header ui-corner-all col-10 justify-content-center flex-column" style="display:none"></div>

        <!--PAGINA 5 SUBIDA ARCHIVOS------------------------------------------------------------------------------------------>
