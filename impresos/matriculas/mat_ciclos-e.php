...
<body>
    <div class="container w-100">
        ...
        <div class="d-flex flex-row justify-content-center" style="margin-top:30px">
            ...
            <div class="col-8 justify-content-center" style="text-align: center;">
                ...
                <h6>SOLICITUD: COMPLEMENTO MATRÍCULA DE CICLOS FORMATIVOS E-LEARNING (FCT Y PROYECTO)</h6><br>
    ...
    <script src=<?php echo "js/mat_ciclos-e.js?q=".time();?> type="text/javascript"></script>
    <script src=<?php echo "js/validadores_ciclos-e.js?q=".time();?> type="text/javascript"></script>
