...
<body>
    ...
    <div id="div_canvas_firma" style="display:none;display: flex; justify-content: center;">
        <label  style="text-align: center;"><small>Mentenga pulsado el botón del ratón para dibujar la firma.</small></label><br>
        <div id="div_lienzo" >
