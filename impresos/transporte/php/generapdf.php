...
$pdf->SetKeywords('PDF, secretaría,  '. $datos_cen["localidad_centro"].', Impreso Transporte Escolar');
...
$fecha_firma=$datos_cen["localidad_centro"].", a ".substr($fecha_registro,8,2)." de ".$meses[intval(substr($fecha_registro,6,2))-1]." de ".substr($fecha_registro,0,4);
$texto=<<<EOD
